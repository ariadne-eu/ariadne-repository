...
public class ResultDelegateRFMXmlEntity implements IndexSearchDelegate {
	private static Logger log = Logger.getLogger(ResultDelegateRFMXmlEntity.class);

    private int start;
    private int max;

    public ResultDelegateRFMXmlEntity(int start, int max) {
        this.start = start;
        this.max = max;
    }
