...
if(id == null){
	id = "";
}else if(getOrPublishString.equalsIgnoreCase("get") && (CheckDatabase.isAdmin((String)request.getSession().getAttribute("username")) || CheckDatabase.isOwner((String)request.getSession().getAttribute("username"),id))){
	try{
