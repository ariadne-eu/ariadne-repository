...
%>
<form METHOD=POST name=form id=form ACTION="addOaiTarget.jsp" onsubmit="return check();">
<div id="ctr" align="center">
	<div class="install">
		<div id="stepbar">
			<div class="step-off">New Repository</div>
			<div class="step-on">SPI Target</div>
		...
		<div id="right">
			...
			<h1>Introduce the information for the SPI target configuration</h1>
